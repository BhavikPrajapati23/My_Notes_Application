...
import com.example.mynotesapplication.Adapter.NoteRecyclerAdapter
import com.example.mynotesapplication.Model.Notes
...
class MainActivity : AppCompatActivity() , NoteRecyclerAdapter.NoteListener {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("ADD",object : DialogInterface.OnClickListener{
                override fun onClick(p0: DialogInterface?, p1: Int) {
                    ...
                    addNotestoFirebaseDatabse(editText.text.toString())
                }
            })
    ...
    private fun addNotestoFirebaseDatabse(text:String) {
        ...
        ref.child("Notes")
            ...
            .addOnSuccessListener {
                Log.d(TAG,"addOnSuccessListener : Notes Added")
    ...
    override fun handleCheckedChange(isCheck: Boolean, dataSnapshot: DataSnapshot) {
        ...
        dataSnapshot.ref.updateChildren(mapOf)
            .addOnSuccessListener {
                Log.d("MainActivity","Checkbox updated")
            }
            .addOnFailureListener {
                Log.d("MainActivity","Checkbox is not updated")
            }
    }
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Done"){dialogInterface,i ->
                ...
                dataSnapshot.ref.setValue(note)
                    .addOnSuccessListener {
                        Log.d("MainActivvity","Note Updated")
                    }
                    .addOnFailureListener {
                        Log.d("MainActivvity","Note is not Updated")
                    }
            }
            .setNegativeButton("Cancel",null)
            .show()
